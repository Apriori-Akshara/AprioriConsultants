...
export const BATCH_M_ACCEPTED_PRODUCTION_CHECKPOINT = Object.freeze({
 ...
 acceptedTestIds: [FIRST_PRODUCTION_RESULT.testId, SECOND_PRODUCTION_RESULT.testId, THIRD_PRODUCTION_RESULT.testId, FOURTH_PRODUCTION_RESULT.testId, FIFTH_PRODUCTION_RESULT.testId, SIXTH_PRODUCTION_RESULT.testId, SEVENTH_PRODUCTION_RESULT.testId, EIGHTH_PRODUCTION_RESULT.testId, NINTH_PRODUCTION_RESULT.testId, TENTH_PRODUCTION_RESULT.testId],
 questionCounts: [FIRST_PRODUCTION_RESULT.questionCount, SECOND_PRODUCTION_RESULT.questionCount, THIRD_PRODUCTION_RESULT.questionCount, FOURTH_PRODUCTION_RESULT.questionCount, FIFTH_PRODUCTION_RESULT.questionCount, SIXTH_PRODUCTION_RESULT.questionCount, SEVENTH_PRODUCTION_RESULT.questionCount, EIGHTH_PRODUCTION_RESULT.questionCount, NINTH_PRODUCTION_RESULT.questionCount, TENTH_PRODUCTION_RESULT.questionCount],
 status: TENTH_PRODUCTION_RESULT.status, storageMode: 'canonical-runtime-records', nextTestKey: 'PSAT1',
});
export default SAT_SERIES_A_MOCK_10_PRODUCTION;
