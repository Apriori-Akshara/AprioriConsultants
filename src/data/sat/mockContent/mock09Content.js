...
const CONTEXTS = ['wetland restoration studies','neighborhood tree-canopy surveys','museum collection audits','public-transit reliability studies','crop-water monitoring','coastal erosion measurements','language-learning surveys','renewable-energy output records','river habitat comparisons','historic building assessments','urban noise measurements','soil-carbon experiments','pollinator abundance surveys','community health-access studies','mountain snowpack records','archaeological site mapping','local food-market surveys','wildlife corridor monitoring'];
const LENSES = ['multi-season comparisons','matched-location analysis','repeated field measurements','pre-and-post observations','controlled comparisons','regional sampling'];
...
export const PSAT_MOCK_09_CONTENT = buildMock({ testId: 'psat-mock-09', variant: 'psat-nmsqt', assessmentNumber: 9, seed: 16 });
export const SAT_MOCK_09_CONTENT = buildMock({ testId: 'sat-mock-09', variant: 'sat', assessmentNumber: 9, seed: 17 });
validateMockFigureQuality(PSAT_MOCK_09_CONTENT, SAT_MOCK_09_CONTENT);
validateMockSeries(PSAT_MOCK_09_CONTENT, SAT_MOCK_09_CONTENT);
