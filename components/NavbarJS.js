    ...
    <div className={styles.navbar}>
      ...
      <div>
        <ul className={toggle ? `${styles.uldown}` : `${styles.ul}`}>
          ...
          <Link href='/SATMocksSeriesB' className={isActive('/SATMocksSeriesB') ? `${styles.active}`: `${styles.link}`}>SAT Series B</Link>
      ...
      <div className={styles.btnscontainer}>
          <button onClick={()=>{setToggle(!toggle)}} className={toggle ? `${styles.menu} ${styles.opened}` : `${styles.menu}`} aria-label="Main Menu">
            <svg width="50" height="50" viewBox="0 0 100 100">
                ...
                <path className={`${styles.line} ${styles.line3}`} d="M 20,70.999954 H 80.000231 C 80.000231,70.999954 94.498839,71.182648 94.532987,33.288669 94.543142,22.019327 90.966081,18.329754 85.259173,18.331003 79.552261,18.332249 75.000211,25.000058 25.000021,74.999942" />
              </svg>
          </button>
    </div>
