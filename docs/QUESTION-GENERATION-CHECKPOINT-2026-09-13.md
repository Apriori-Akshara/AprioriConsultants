...
**Status:** **ACTIVE / SAT SERIES A MOCKS 1–10, PSAT MOCKS 1–10, AND SAT SERIES B MOCKS 11–12 ACCEPTED AND STORED. SAT13 IN PROGRESS.**
...
### Current production target — SAT Series B Mock 13

**SAT13 is the active implementation target.** It must be generated only after the accepted SAT1–SAT10, PSAT1–PSAT10, SAT11, and SAT12 baselines. The SAT13 gate compares R&W context/prompt reuse, Math application reuse, exact figure-data reuse, and figure originality against all 22 previously accepted mocks and preserves the established figure-quality, Math mathematical-QC, canonical-schema, 196-record, and storage round-trip gates.
...
- deterministic generation seed: `1013`
